...
- Migração versionada de confirmação CBF aplicada no Supabase; histórico remoto e registro canônico reconciliados.
...
- Detalhes e validação: [nota da versão](docs/releases/v6.42.0-destaques-ao-vivo.md).
...
- Mantém os eventos na posição lateral validada e torna seu fundo mais transparente.
