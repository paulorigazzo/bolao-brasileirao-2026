...
| Bootstrap e fundação isolada do Bolão Brasileirão Rigazzo | R00 e R00.1 concluídas; R01A não iniciada | Criar o repositório, realizar o handoff e abrir ambiente próprio para Temporadas e Ligas, sem fundação experimental no Bolão 2026 | Alto | Alto estratégico | **LP em fases** | [Arquitetura do Rigazzo](architecture/BOLAO_BRASILEIRAO_RIGAZZO.md), R01A e aprovações próprias |
| Snapshots comparativos de 2026 | Não iniciado | Inventariar a origem, formalizar o contrato, homologar o importador e transferir pacotes manuais sem conexão entre bancos | Alto | Alto técnico | **LP em fases** | R03–R09, consentimento e ferramentas homologadas |
