...
1. **Ligas com palpites compartilhados:** L01 a L10 concluídas, incluindo a validação operacional da jornada unificada de novos participantes;
...
- ✅ Comunicação individual e manual via WhatsApp na gestão de participantes e ações compactas de WhatsApp, notificação e consulta dos jogos na Situação da Rodada.
...
- ✅ Cards expandidos oferecem Estatísticas e Escalações em seções recolhíveis, com titulares estáticos em Lista e Campo, cartões associados por jogador e banco interno recolhível com substituições; a cobertura histórica piloto parte da Rodada 26.
