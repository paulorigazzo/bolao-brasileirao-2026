...
- Jogos reagendados da Rodada 21: contexto e comunicação no app preparados na v6.44.2; migração de confirmação oficial das duas datas preparada, com aplicação remota e validação visual local ainda pendentes.
