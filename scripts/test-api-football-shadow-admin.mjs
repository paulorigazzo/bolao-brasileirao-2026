...
assert.doesNotMatch(app, /id="adminShadowForm"/);
...
console.log("Coleta em sombra oculta na ADM e mecanismo interno preservado: autenticação, confirmação, validação e resposta sanitizada.");
