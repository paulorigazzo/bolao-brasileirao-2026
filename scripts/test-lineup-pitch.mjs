...
assert.match(app, /premium-pitch-player-toggle/);
assert.match(app, /aria-expanded="false"/);
assert.match(app, /closePitchPlayerDetails/);
assert.match(app, /if\(event\.key==="Escape"\) closePitchPlayerDetails/);
assert.match(app, /<b>Eventos<\/b>/);
assert.match(app, /events\.goals\.map\(goal=>`<span aria-hidden="true">⚽<\/span>`/);
assert.doesNotMatch(app, /is-pitch-summary[^`]*goal\.minute/);
assert.match(styles, /premium-pitch-player-details\[hidden\]/);
assert.match(styles, /premium-pitch-player\.is-edge-left>\.premium-pitch-player-details/);
assert.match(styles, /premium-pitch-player-toggle:focus-visible/);
assert.match(app, /premium-pitch-small-box is-top/);
assert.match(app, /premium-pitch-small-box is-bottom/);
assert.match(app, /premium-pitch-arc is-top/);
