...
const migration = (await readFile(new URL("../supabase/migrations/20260825060519_add_idempotency_round_shadow_5b3b.sql", import.meta.url), "utf8"))
...
assert.match(migration, /versão registrada remotamente pelo supabase: 20260825060519/);
