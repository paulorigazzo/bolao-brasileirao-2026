...
const required = [
  ...
  "scripts/test-round-highlights-engine.mjs", "scripts/test-participant-duel-engine.mjs", "scripts/test-admin-round-share.mjs", "scripts/test-match-calendar-engine.mjs",
