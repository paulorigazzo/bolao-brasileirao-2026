...
const required = [
  ...
  "src/sports-data/contract.mjs", "src/sports-data/api-football-adapter.mjs", "src/sports-data/api-football-reconciliation.mjs", "src/sports-data/api-football-mapping-migration.mjs", "src/sports-data/crest-audit.mjs", "src/sports-data/api-football-local-crests.mjs",
