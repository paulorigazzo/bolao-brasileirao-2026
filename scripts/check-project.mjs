...
const required = [
  "index.html", "css/design-system.css", "css/components.css", "css/styles.css", "js/app.js", "js/config.js", "js/motion.js", "js/statistics-engine.js", "js/round-highlights-engine.js", "js/participant-duel-engine.js", "js/friendly-rankings-engine.js", "js/admin-round-share.js", "js/admin-pick-progress.js", "js/match-calendar-engine.js",
  "scripts/test-round-highlights-engine.mjs", "scripts/test-participant-duel-engine.mjs", "scripts/test-friendly-rankings-engine.mjs", "scripts/test-admin-round-share.mjs", "scripts/test-admin-pick-progress.mjs", "scripts/test-match-calendar-engine.mjs", "scripts/test-games-calendar-entry.mjs",
  "src/sports-data/contract.mjs", "src/sports-data/api-football-adapter.mjs", "src/sports-data/api-football-reconciliation.mjs", "src/sports-data/api-football-mapping-migration.mjs", "src/sports-data/crest-audit.mjs",
  "scripts/test-api-football-adapter.mjs", "scripts/test-api-football-crest-audit.mjs", "scripts/audit-api-football-crests.mjs", "scripts/test-api-football-reconciliation.mjs", "scripts/test-api-football-mapping-migration.mjs", "scripts/reconcile-api-football-season.mjs", "scripts/generate-api-football-mapping-migration.mjs", "fixtures/api-football/fixture-1492340.sanitized.json", "fixtures/api-football/standings-brasileirao.synthetic.json",
