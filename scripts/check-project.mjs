...
const required = [
  ...
  "scripts/test-api-football-adapter.mjs", "scripts/test-api-football-crest-audit.mjs", "scripts/test-api-football-local-crests.mjs", "scripts/sync-api-football-local-crests.mjs", "scripts/audit-api-football-crests.mjs", "scripts/test-api-football-reconciliation.mjs", "scripts/test-api-football-mapping-migration.mjs", "scripts/test-api-football-round-reconciliation.mjs", "scripts/reconcile-api-football-season.mjs", "scripts/generate-api-football-mapping-migration.mjs", "fixtures/api-football/fixture-1492340.sanitized.json", "fixtures/api-football/standings-brasileirao.synthetic.json", "fixtures/api-football/teams-brasileirao-2026.json",
