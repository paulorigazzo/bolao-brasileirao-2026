...
const required = [
  "index.html", "css/design-system.css", "css/components.css", "css/styles.css", "js/app.js", "js/config.js", "js/web-push.js", "js/push-activation-prompt.js", "js/game-details.js", "js/lineup-pitch.js", "js/lineup-match-events.js", "js/lineup-shirt-themes.js", "service-worker.js", "js/motion.js", "js/statistics-engine.js", "js/round-highlights-engine.js", "js/participant-duel-engine.js", "js/friendly-rankings-engine.js", "js/admin-round-share.js", "js/admin-pick-progress.js", "js/my-team-moments.js", "js/match-calendar-engine.js",
  "scripts/test-update-actions.mjs", "scripts/test-round-highlights-engine.mjs", "scripts/test-participant-duel-engine.mjs", "scripts/test-friendly-rankings-engine.mjs", "scripts/test-admin-round-share.mjs", "scripts/test-admin-pick-progress.mjs", "scripts/test-my-team-moments.mjs", "scripts/test-match-calendar-engine.mjs", "scripts/test-games-calendar-entry.mjs",
  "src/sports-data/contract.mjs", "src/sports-data/api-football-adapter.mjs", "src/sports-data/api-football-game-details.mjs", "src/sports-data/api-football-game-details-backfill.mjs", "src/sports-data/api-football-reconciliation.mjs", "src/sports-data/api-football-mapping-migration.mjs", "src/sports-data/crest-audit.mjs", "src/sports-data/api-football-local-crests.mjs", "src/sports-data/api-football-team-catalog.mjs",
  "scripts/test-api-football-adapter.mjs", "scripts/test-api-football-crest-audit.mjs", "scripts/test-api-football-local-crests.mjs", "scripts/sync-api-football-local-crests.mjs", "scripts/audit-api-football-crests.mjs", "scripts/test-api-football-reconciliation.mjs", "scripts/test-api-football-mapping-migration.mjs", "scripts/test-api-football-round-reconciliation.mjs", "scripts/test-api-football-round-27-mapping.mjs", "scripts/reconcile-api-football-season.mjs", "scripts/generate-api-football-mapping-migration.mjs", "fixtures/api-football/fixture-1492340.sanitized.json", "fixtures/api-football/standings-brasileirao.synthetic.json", "fixtures/api-football/teams-brasileirao-2026.json",
  "scripts/test-api-football-foundation.mjs", "supabase/migrations/20260825021432_fundacao_sombra_api_football.sql", "supabase/migrations/20260825050228_gravacao_mapeamentos_api_football_5b2.sql", "supabase/rollback/rollback_gravacao_mapeamentos_api_football_5b2.sql", "supabase/migrations/20260908125715_map_api_football_round_27.sql", "supabase/rollback/rollback_map_api_football_round_27.sql",
  "scripts/test-game-details.mjs", "scripts/test-game-details-backfill.mjs", "scripts/test-lineup-reserves-round-26-migration.mjs", "scripts/test-lineup-pitch.mjs", "scripts/test-lineup-match-events.mjs", "scripts/backfill-api-football-game-details.mjs", "supabase/migrations/20260909220000_add_game_details_projection.sql", "supabase/rollback/rollback_add_game_details_projection.sql", "supabase/migrations/20260910162957_backfill_lineup_reserves_round_26.sql", "supabase/rollback/rollback_backfill_lineup_reserves_round_26.sql",
  ...
  "netlify/functions/_api-football-shadow.mjs", "netlify/functions/_api-football-round-shadow.mjs", "netlify/functions/coletar-sombra-api-football.mjs", "netlify/functions/coletar-sombra-rodada-api-football-agendado.mjs", "netlify/functions/_participant-communication-status.mjs", "netlify/functions/status-comunicacao-participantes.mjs", "scripts/test-api-football-shadow.mjs", "scripts/test-api-football-round-shadow.mjs", "scripts/test-api-football-round-shadow-schedule.mjs", "scripts/test-api-football-round-shadow-idempotency.mjs", "scripts/test-api-football-shadow-admin.mjs",
  ...
  "netlify/functions/diagnostico-sistema.mjs", "netlify/functions/_api-football-local-crests.mjs", "netlify/functions/_api-football-round-reconciliation.mjs", "netlify/functions/reconciliar-api-football-rodada.mjs", "netlify/functions/configuracao-web-push.mjs", "netlify/functions/enviar-lembrete-palpites.mjs", "scripts/test-manual-web-push.mjs",
...
await import("./test-update-actions.mjs");
