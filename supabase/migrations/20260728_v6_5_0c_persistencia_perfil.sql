-- Bolão Brasileirão 2026 — v6.5.0c
-- Hotfix de persistência e propagação do perfil.
-- Execute no SQL Editor do Supabase antes de publicar a v6.5.0c.
...
begin
  ...
  update public.palpites
     set usuario = v_name
   where user_id = v_uid
     and usuario is distinct from v_name;
